...
int main()
{
   ...
   // IntList listTesting;
   // cout << "\npushfront 10";
   //    listTesting.push_front( 10 );
   //    cout << "\npushfront 20";
   //    listTesting.push_front( 20 );
   //    cout << "\npushfront 30";
   //    listTesting.push_front( 30 );
   //    cout << "\nlist1: ";
   //    listTesting.display();
   //    cout << "\npop";
   //    listTesting.pop_front();
   //    cout << "\nlist1: ";
   //    listTesting.display();
   //    cout << "   outputting list with << :" << endl;
   //    cout << listTesting << endl;
      
   //    cout << "\npushback 10";
   //    listTesting.push_back( 10 );
   //    cout << "\npushback 20";
   //    listTesting.push_back( 20 );
   //    cout << "\npushback 30";
   //    listTesting.push_back( 30 );
   //    cout << "\nlist2: ";
   //    listTesting.display();
      
   //    cout << "\nselection_sort()";
   //    listTesting.selection_sort();
   //    cout << "\nlist3: ";
   //    listTesting.display();
      
   //    cout << "\ninsert 20";
   //    listTesting.insert_ordered( 20 );
   //    cout << "\ninsert 10";
   //    listTesting.insert_ordered( 10 );
   //    cout << "\ninsert 30";
   //    listTesting.insert_ordered( 30 );
   //    cout << "\nlist4: ";
   //    listTesting.display();
   ...
   //    cout << "   outputting list with << :" << endl;
   //    cout << listTesting << endl;
   //    cout << "\nremove_duplicates()HERE IT BREAKS" << flush;
   //    listTesting.remove_duplicates();
   //    cout << "\nlist5: " << flush;
   //    listTesting.display();
   //    cout << "\npush_front(30)";
   //    listTesting.push_front(30);
